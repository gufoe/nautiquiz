<template>
  <q-dialog :model-value="modelValue" @update:model-value="emit('update:modelValue', $event)" @hide="emit('closed')">
    <q-card class="leaderboard-card">
      ...
      <q-card-actions align="center">
        <q-btn flat color="primary" label="Tocca per continuare" @click="emit('update:modelValue', false)" />
      </q-card-actions>
    </q-card>
  </q-dialog>
</template>
